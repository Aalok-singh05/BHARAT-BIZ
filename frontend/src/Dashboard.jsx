...
const MerchantDashboard = () => {
  ...
  return (
    <div className="p-6 md:p-8 max-w-[1600px] mx-auto animate-fadeInUp">
      
      {/* 1. Header Area (Inside content) */}
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold mb-2 gradient-text">Dashboard Overview</h1>
          <p className="text-[#a89d94]">Welcome back, Mukesh</p>
        </div>
        <div className="flex gap-4">
           {/* New Order Button */}
           <button 
             onClick={() => setIsModalOpen(true)}
             className="glass-card px-6 py-3 rounded-xl bg-[#ff9f43] text-[#0a0808] font-bold hover:scale-105 transition-transform shadow-[0_0_20px_rgba(255,159,67,0.3)]"
           >
             + New Order
           </button>
        </div>
